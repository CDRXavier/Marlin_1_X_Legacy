...
#define EXTRUDER_AUTO_FAN_TEMPERATURE 80//50
...
#define MICROSTEP_MODES { 8, 8, 8, 8, 8 } //{16, 16, 16, 16, 16} // [1,2,4,8,16]
...
#define DIGIPOT_MOTOR_CURRENT { 55,55,70,55,55 } //{ 135,135,135,135,135 }   // Values 0-255 (RAMBO 135 = ~0.75A, 185 = ~1A)
